...
> 汇总自 [DeepSeek API 文档](https://api-docs.deepseek.com/)、[官网](https://www.deepseek.com/) 及公开报道，当前覆盖 2026 年 4 月至 7 月。
...
核心差异化：用 MIT 开源 + 极致性价比，对闭源模型形成"Opus 级能力、1/7 价格"的钳形攻势。
