...
> 课程元信息以 `curriculum.yaml` 为准；本表仅展示当前主线版本。

| 阶段 | 名称 | 周期 | 课时 | 项目数 | 目标角色 |
|------|------|------|------|--------|----------|
| L0 | 预备阶段：编程基本功 | 8周 | 160h | 3 | 编程入门 |
| L1 | 初级工程师：大数据入门 | 8周主线 | 200h | 3核心 + 1补充 | 大数据初级工程师 |
| L2 | 中级工程师：工程深化 | 8周主线 + 补充模块 | 320h主线 + 85h补充 | 3核心 + 5补充 | 大数据中级工程师 |
| L3 | 高级工程师：技术深度 | 14周主线 + 补充模块 | 400h主线 + 140h补充 | 2核心 + 2补充 | 大数据高级工程师 |
| L4 | 架构师：全局设计 | 20周主线 + 补充模块 | 480h面授 + 600h自学 | 3核心 + 1补充 | 数据架构师 |
| L5 | CTO视野：战略领导 | 持续 | 按需 | 1 | CTO/技术VP |

> **总课时**：主线与补充模块分层计算，详见 `curriculum.yaml`。
